...
{
    public abstract class BasicAuthenticationFilter : Attribute, IAutofacAuthenticationFilter
    {
        ...
        public async Task AuthenticateAsync(HttpAuthenticationContext context, CancellationToken cancellationToken)
        {
            ...
            if (!TryGetUserNameAndPassword(authorization.Parameter, out userName, out password))
            {
                // Authentication was attempted but failed. Set ErrorResult to indicate an error.
        ...
        private static bool TryGetUserNameAndPassword(string authorizationParameter, out string userName, out string password)
        {
            userName = null;
            password = null;
